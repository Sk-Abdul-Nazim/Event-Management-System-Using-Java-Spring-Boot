                       ...
                       <section id="main-content">
                           ...
                           <section class="center">
                               <div>
                                   <div>
                                       <div>
                                       <c:forEach items="${getCityNameWithParticularId}" var="list">
                                           <input type="hidden" name="editCityId" value="${list.cityId}">
                                           <lable>City Name :</lable>
                                           <input type="text" name="cityname" id="cityname" placeholder="Enter City Name" value="${list.cityName}" onfocus="this.select();" onkeyup="javascript:capitalize(this.id, this.value);" autofocus>
                                           </tr>
                                           </c:forEach>
                                         </div>
                                       <br>
                                       <div>
                                         ...
                                         <button>  <a href="/city" style="text-decoration: none;">Back</a> </button>
                                       </div>

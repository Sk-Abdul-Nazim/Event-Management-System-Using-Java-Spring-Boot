                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 p-l-0 title-margin-left">
                            <div class="page-header">
                                <div class="page-title">
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item"><a href="/activeHall">Dashboard</a></li>
                        ...
                        <div class="dropdown right">
                           ...
                           <a href="#?shname=sort">By Name</a>
                           <a href="#?shplace=sortPlace">By Place Name</a>
                           <a href="#?shcity=sortCity">By City Name</a>
                           </div>
                        </div>
                        <!-- /# column -->
                    </div>
                    ...
                    <section id="main-content">
                         ...
                         <br>
                           <table>
                            ...
                            <%int count=0; %>
                           <c:forEach items="${allActiveHall}" var="list">
...
<%--                                    <c:set var="path" value="/imagesFile/"/> --%>
                                <c:set var="pathWithImageName" value= "${path}${list.hallImage}" />
                                 ...
                                 <c:set var="fullPath" value="E:\\SPRING-BOOT-PROJECTS\\EMS\\src\\main\\resources\\static\\images\\hallImageDB\\"/>
<%--                                 <c:set var="fullPath" value="E:\\HallImageDBDrive\\"/> --%>
                              ...
                              <td><a style="text-decoration:none" href="/editActiveHall?id=${list.hallId}&catId=${list.hallCategoryId}&citId=${list.hallCityId}">Edit </a> |
                              <a style="text-decoration:none" href="javascript:void(0);" onclick="chk('${list.hallId}');">Delete</a>
                            ...
                            <br>
                            <div class="center">
                            <a href="/addActiveHall" style="padding-left:8px;">Add Hall</a>
                          </div>
...
function chk(val){
 ...
 if(result){
   location.href="/deleteActiveHall?id="+val;
 }

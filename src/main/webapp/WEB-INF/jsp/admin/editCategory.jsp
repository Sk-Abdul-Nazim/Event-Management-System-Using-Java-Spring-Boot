                       ...
                       <section id="main-content">
                           ...
                           <section class="center">
                               <div>
                                   <div>
                                       <div>
                                        <c:forEach items="${getCategoryNameWithParticularId}" var="list">
                                           <input type="hidden" name="editCategoryId" value="${list.categoryId }">
                                           <lable>Category Name :</lable>
                                           <input type="text" name="catname" id="catname" placeholder="Enter Category Name" value="${list.categoryName}" onfocus="this.select();" onkeyup="javascript:capitalize(this.id, this.value);" autofocus required>
                                           </tr>
                                             </c:forEach>
                                         </div>
                                       <br>

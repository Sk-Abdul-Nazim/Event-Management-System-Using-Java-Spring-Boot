                ...
                <div class="container-fluid">
                    ...
                    <section id="main-content">
                         ...
                         <br>
                          ...
                          <%int count=0; %>
                           <c:forEach items="${allCity}" var="list">
									<tr>
										<td><% count=count+1;
                                       out.println(count);%></td>
										<td>${list.cityName}</td>
										
										<td><a href="/editCity?id=${list.cityId}" >Edit</a>|

										 <a href="javascript:void(0);" onclick="chk('${list.cityId}');">Delete</a></td> 
...
function chk(val){
 ...
 if(result){
   location.href="/deleteCity?id="+val;
 }
